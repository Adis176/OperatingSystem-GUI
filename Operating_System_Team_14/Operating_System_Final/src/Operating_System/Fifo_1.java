...
public class Fifo_1 extends JFrame {
	...
	public Fifo_1() {
		...
		label.setIcon(new ImageIcon(Fifo_1.class.getResource("/Images/Simulator (2).png")));
		label.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				dispose();
				Simulation open = new Simulation();
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addComponent(scrollPane_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 925, Short.MAX_VALUE)
		...
		JLabel Operating = new JLabel("OPERATING\r\n");
		Operating.setForeground(Color.WHITE);
		Operating.setFont(new Font("Stencil", Font.PLAIN, 19));
		...
		System.setFont(new Font("Stencil", Font.PLAIN, 20));
			...
			groupLayout_1.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout_1.createSequentialGroup()
					...
					.addGroup(groupLayout_1.createParallelGroup(Alignment.LEADING)
						.addComponent(System, GroupLayout.PREFERRED_SIZE, 113, GroupLayout.PREFERRED_SIZE)
						.addComponent(Operating, GroupLayout.PREFERRED_SIZE, 113, GroupLayout.PREFERRED_SIZE)))
				.addGroup(groupLayout_1.createSequentialGroup()
					.addGap(24)
					.addGroup(groupLayout_1.createParallelGroup(Alignment.LEADING)
			...
			groupLayout_1.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout_1.createSequentialGroup()
					...
					.addGroup(groupLayout_1.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout_1.createSequentialGroup()
							.addGap(25)
							.addComponent(System, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE))
						.addComponent(Operating, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
					.addGap(86)
