...
public class About_Us extends JFrame {
	...
	public About_Us() {
		...
		lblNewLabel_3_1_2_1.setBounds(490, 10, 155, 309);
		panel_1.add(lblNewLabel_3_1_2_1);
		lblNewLabel_3_1_2_1.setIcon(new ImageIcon("C:\\Users\\KHUSHI\\Downloads\\adi (1).png"));
		
		JPanel panel_5 = new JPanel();
		panel_5.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_5.setBounds(10, 10, 799, 465);
		panel_5.setBackground(SystemColor.text);
		panel_1.add(panel_5);
		panel_5.setLayout(null);
		
		JLabel lblNewLabel_3_1 = new JLabel("");
		lblNewLabel_3_1.setIcon(new ImageIcon("C:\\Users\\KHUSHI\\Desktop\\Operating_System_Final\\Operating_System_Final\\src\\Images\\khushif.jpg"));
		lblNewLabel_3_1.setBounds(168, 10, 158, 309);
		panel_5.add(lblNewLabel_3_1);
		
		JLabel lblNewLabel_3_1_1 = new JLabel("");
		lblNewLabel_3_1_1.setIcon(new ImageIcon("C:\\Users\\KHUSHI\\Downloads\\a792675d-8f1e-4761-be0b-35b3f6b125c0.png"));
		lblNewLabel_3_1_1.setBounds(7, 146, 158, 309);
		panel_5.add(lblNewLabel_3_1_1);
		
		JLabel lblNewLabel_3_1_2 = new JLabel("");
		lblNewLabel_3_1_2.setIcon(new ImageIcon("C:\\Users\\KHUSHI\\Downloads\\badal (1).png"));
		lblNewLabel_3_1_2.setBounds(318, 156, 158, 309);
		panel_5.add(lblNewLabel_3_1_2);
		
		JLabel lblNewLabel_3_1_2_2 = new JLabel("");
		lblNewLabel_3_1_2_2.setIcon(new ImageIcon("C:\\Users\\KHUSHI\\Downloads\\Screenshot 2021-04-23 000909 (1).png"));
		lblNewLabel_3_1_2_2.setBounds(640, 164, 155, 280);
		panel_5.add(lblNewLabel_3_1_2_2);
		...
		panel_6.setBounds(10, 10, 799, 465);
		panel_2.add(panel_6);
		panel_6.setLayout(null);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel_3.setIcon(new ImageIcon(About_Us.class.getResource("/Images/OurTeam.png")));
		lblNewLabel_3.setBounds(8, 10, 779, 447);
		...
		JTextField txtOurTeam = new JTextField();
		txtOurTeam.setEditable(false);
		txtOurTeam.setBackground(new Color(230, 230, 250));
		txtOurTeam.setFont(new Font("Bookman Old Style", Font.BOLD, 24));
		txtOurTeam.setHorizontalAlignment(SwingConstants.CENTER);
		txtOurTeam.setText("Our Team");
		txtOurTeam.setColumns(10);
		txtOurTeam.setBounds(170, 21, 824, 60);
		contentPane.add(txtOurTeam);
